...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsMessageBoxJsx = __webpack_require__(157);

	var _componentsMessageBoxJsx2 = _interopRequireDefault(_componentsMessageBoxJsx);

	_react2['default'].render(_react2['default'].createElement(_componentsMessageBoxJsx2['default'], null), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageBox = (function (_React$Component) {
	  ...
	  _createClass(MessageBox, [{
	    key: 'updateTxt',
	    value: function updateTxt(e) {
	      this.setState({
	        red: _react2['default'].findDOMNode(this.refs.red.refs.range).value,
	        green: _react2['default'].findDOMNode(this.refs.green.refs.range).value,
	        blue: _react2['default'].findDOMNode(this.refs.blue.refs.range).value
	      });
	    }
	  }, {
	    key: 'render',
	  ...
	  _createClass(Slider, [{
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement("input", { ref: "range", defaultValue: "0", type: "range", onChange: this.props.range })
	      );
	    }
	  }]);
